...
function PositionsZeros(psi0::Vector{Complex{Float64}},tcirc::Vector{Complex{Float64}},hbar::Float64,Nmax::Int64,om::Float64,r::Float64,lambda::Float64,delta::Float64,eta,psi,nsubint,nsubint2)
	 ...
	 counter = 0
	 open("position_zeros.dat","w") do io
	 for i in 1:(nsubint)
	   for j in 1:(nsubint)
...
println("Number of zeors on the right of the real axis: ",rrr)
